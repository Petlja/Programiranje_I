...
- ``ima_loptica_na_polju()`` - проверава да ли на пољу на ком се робот
  налази има лоптица,
- ``broj_loptica_na_polju()`` - враћа број лоптица на поље на ком се
  робот налази,
...
.. questionnote::
   ...
   лавиринту увек стиже до лоптице и узима је. Не заборави да помоћу
...
исправно ради без обзира на то што се зачарани лавиринт променио.
...
Приметићете и да се након услова петље ``while`` пише двотачка, док се
редови у којима се пишу наредбе које се понављају увлаче (веома слично као у случају 
петље ``for``). Сличне су и поруке о грешкама уколико се ово правило не испоштује.
...
Овим програмом се роботу каже следеће: „Онолико пута колико је на
