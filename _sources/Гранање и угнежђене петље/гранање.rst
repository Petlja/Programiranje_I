...
тачке. Размотрићемо неколико примера цртежа у којима се јавља овај облик
правилности и приказаћемо неке од могућности да се такви цртежи нацртају.
...
Приметићете да смо наредбом гранања (наредби `if-else`) само поставили
