...
Израчунај унутрашње и спољашње углове звезде са пет кракова. Пошто је
збир унутрашњих углова правилног петоугла једнак `(5-2)\cdot 180`,
сваки његов унутрашњи угао правилног многоугла је
...
тако што ћеш пет пута нацртати дуж од 100 корака и затим се окренути
...
.. questionnote::
   ...
   Напиши програм који црта пахуљу која има осам кракова дужине од по 50
   пиксела.
