...
Уместо збира цифара контролни број се понекад рачуна на овај начин: :math:`c_0 + 2c_1 + 3c_2 + 4c_3 + 5c_4`. 
Покушај да измениш претходни програм тако да израчунава контролни број на овај начин.

.. learnmorenote:: Протоколи за размену података
   ...
   *протокола за размену података*. Иако је контролни збир
   ...
   уместо збира цифара понекад користе изрази облика :math:`c_0 + 2c_1 +
   3c_2 + 4c_3 + 5c_4`. 
