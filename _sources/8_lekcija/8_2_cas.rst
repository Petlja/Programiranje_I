...
Хајде да се заједно присетимо шта је то реално, а шта целобројно дељење. Погледај наредни видео.
...
језику Пајтон3 обележава косом цртом, тј. знаком ``/``. Тако је вредност израза ``7.5 /
2.5`` једнака ``3.0``.
...
.. questionnote::
   ...
   0,7. Израчунај ту вредност користећи Пајтон.
...
Целобројно дељење подразумева дељење целих бројева и као
...
.. reveal:: целобројно_дељење
  ...
  :hidetitle: Сакриј
   ...
   :math:`a = q \cdot b + r` и :math:`0 \leq r < b`. Приметићеш
   да у примеру дељења :math:`14` и :math:`3` важи управо ова
   ...
   На пример, важи да је :math:`14 = 3 \cdot 3 + 5`.
...
У језику Пајтон3 операција **целобројног дељења** се означава са
