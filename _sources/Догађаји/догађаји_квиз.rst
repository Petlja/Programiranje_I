...
.. mchoice:: drzanje_tastera
    ...
    Ако држимо притиснут неки тастер тастатуре (при том нисмо претходно мењали подразумевани начин генерисања догађаја тастатуре)...
...
.. mchoice:: dkeypojedinacno
    ...
    Којом од понуђених линија кода се врши провера да ли је притиснут тастер слова A?
