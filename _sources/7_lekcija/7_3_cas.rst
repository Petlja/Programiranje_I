...
он покрене на већем броју унапред припремљених примера (у којима
...
нулу). Притисни дугме *Тест* и видећеш да резултати који
...
су обележени - остале редове не дирај. Када завршиш, поново притисни
...
Корисна техника која помаже да се боље разуме како ради неки
...
специјализованом окружењу за развој програма, какво је *Python IDLE*. 
Таква окружења такође омогућавају извршавање програма корак по
