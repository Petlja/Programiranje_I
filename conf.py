...
project = 'Petlja - Настава програмирања за Први разред гимназије'
...
html_context = {'course_id': 'Настава програмирања за Први разред гимназије',
...
html_theme_options = {
    ...
    'navbar_title': "Petlja - Настава програмирања за Први разред гимназије",
...
html_title = 'Petlja - Настава програмирања за Први разред гимназије'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Petlja - Настава програмирања за Први разред гимназије'
...
htmlhelp_basename = 'Настава програмирања за Први разред гимназије-doc'
